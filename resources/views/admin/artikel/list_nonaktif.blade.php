...
@section('content')
  ...
  <div class="jumbotron py-1">
    <h2>Kelola Artikel (NON - Aktif)</h2>
    <p>Halaman ini berisi daftar artikel yang perlu diverifikasi sebelum tampil dalam situs {{ $aum->name }}. <br><br>
...
$('#datatable').DataTable({
    processing: true,
    serverSide: true,
    ajax: '{{ url("admin/kelola/artikel/nonaktif/getdata/") }}',
    columns: [
