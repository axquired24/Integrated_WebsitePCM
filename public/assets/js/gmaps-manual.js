...
function gmaps_init(){
  ...
  // Set my Location
  var myLatLng = {lat: -7.5537765, lng: 110.763271};

  // infoWindows
  var contentString = "<h2>Arsyfa Hijab</h2>";

  // center of the universe
  var latlng = new google.maps.LatLng(-7.5537765,110.763271);
